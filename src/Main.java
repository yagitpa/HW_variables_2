public class Main {
    ...
    // Задача 8
        ...
        int zpMashaYearBefore = zpMasha * 12; // вычисляем годовой доход Маши до повышения
        int zpMashaYearAfter = newZpMasha * 12; // вычисляем годовой доход Маши после повышения
        int zpDenisYearBefore = zpDenis * 12; // вычисляем годовой доход Дениса до повышения
        int zpDenisYearAfter = newZpDenis * 12; // вычисляем годовой доход Дениса после повышения
        int zpKristinaYearBefore = zpKristina * 12; // вычисляем годовой доход Кристины до повышения
        int zpKristinaYearAfter = newZpKristina * 12; // вычисляем годовой доход Кристины после повышения
